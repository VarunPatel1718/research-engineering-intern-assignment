...
EVENTS = [
    {"date":"2024-07-21","event":"Biden drops out of 2024 race","type":"election"},
    ...
    {"date":"2024-11-06","event":"Trump wins 2024 election","type":"election"},
...
with open(f"{DATA}/events.json","w") as f: json.dump(EVENTS,f)
